...
output_file_name = 'helico_preprocessed_00to09.csv'
...
input_file_name_2 = "heli_results_2008to2020.csv"
output_file_name = 'helico_preprocessed_08to20.csv'
df_init_2 = preprocessing(WORK_PATH, SAVE_PATH, input_file_name_1, input_file_name_2, output_file_name)
# %% Concatenate multiple dataframes
df_preprocessed = pd.concat((df_init_1, df_init_2), axis=0)
display(df_preprocessed.head())
# %%
#### Save preprocessed data
df_preprocessed.to_csv('../prepro_data/nlp_helico_set.csv', index=False, encoding='utf-8-sig')
# %%
