...
def preprocessing(WORK_PATH, SAVE_PATH, input_file_name, input_file_name_2,output_file_name):
    ...
    #### Read label data
    df_results = datatable.fread(os.path.join(WORK_PATH, "data/"+input_file_name_2),
                                na_strings=['', 'NA'], encoding='utf-8-sig').to_pandas()
    #### Change data type to datetime64 from object
